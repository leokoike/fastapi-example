...
from data import TVShow, User, UserTVShow
...
def convert_user(schema: UserSchema, get_tvshows: bool = True) -> User:
    ...
    if get_tvshows:
        tvshows = (
            [
                _convert_user_tvshow_from_user(user_tvshow)
...
def _convert_user_tvshow_from_user(schema: UserTVShowSchema) -> UserTVShow:
